  ...
  <section>
    ...
    >
      <b-card-header>
        ...
        >
          <b-card-title>Módulos del {{ dataSistema.nombre }}</b-card-title>
        </b-col>
...
import ModuloForm from './ModuloForm.vue'
...
export default {
  ...
  data: () => ({
    ...
    items: [],
    fields: [
      { key: 'idModulo', sortable: true, tdClass: 'd-none', thClass: 'd-none' },
      { key: 'nombre', sortable: true },
      { key: 'abreviatura', sortable: true },
      { key: 'icono', sortable: true },
      { key: 'esquema', sortable: true },
  ...
  methods: {
    ...
    getDelete(data) {
      this.$swal({
        ...
        if (result.value) {
          store
            .dispatch('seguridad/MODULO_DELETE', {
